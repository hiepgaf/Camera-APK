...
public class ScriptIntrinsicColorMatrix extends ScriptIntrinsic {
    ...
    public void setAdd(float f, float f2, float f3, float f4) {
        ...
        fieldPacker.addF32(this.mAdd.f764x);
        fieldPacker.addF32(this.mAdd.f765y);
        fieldPacker.addF32(this.mAdd.f766z);
        fieldPacker.addF32(this.mAdd.f763w);
        setVar(1, fieldPacker);
    }

    public void setAdd(Float4 float4) {
        Float4 float42 = this.mAdd;
        float42.f764x = float4.f764x;
        float42.f765y = float4.f765y;
        float42.f766z = float4.f766z;
        float42.f763w = float4.f763w;
        FieldPacker fieldPacker = new FieldPacker(16);
        fieldPacker.addF32(float4.f764x);
        fieldPacker.addF32(float4.f765y);
        fieldPacker.addF32(float4.f766z);
        fieldPacker.addF32(float4.f763w);
        setVar(1, fieldPacker);
    }
