...
/* compiled from: PG */
/* renamed from: gwu */
public final class gwu extends gwz {
    static {
        bli.m862a("AutoFocusRing");
    }

    public gwu(gzk gzk, Paint paint) {
        super(gzk, paint, 250.0f);
    }
    ...
    public final void mo3065a(long j, long j2, Canvas canvas) {
        ...
        if (mo1664a()) {
            ...
            this.b.invalidate();
            if (this.n == go.bi) {
                a2 = (int) ((this.e.m2956a(gzj.m11685a(j, this.k, this.g)) * 255.0f) + 0.0f);
            } else if (this.n == go.bk) {
