...
public final class axl implements TimeInterpolator {
    ...
    public final float getInterpolation(float f) {
        ...
        int min = Math.min((int) (((float) (f1009b.length - 1)) * f), f1009b.length - 2);
        float f2 = f1010c;
        float f3 = f1010c;
        return ((f1009b[min + 1] - f1009b[min]) * ((f - (f2 * ((float) min))) / f3)) + f1009b[min];
    }
}
