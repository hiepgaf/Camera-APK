...
public class iir {
    ...
    /* renamed from: a */
    public static iir m3759a(Context context) {
        htl.m3431b((Object) context);
        synchronized (iir.class) {
            if (f7008a == null) {
                f7008a = new iir(context);
            }
        }
        return f7008a;
    }
    ...
    /* renamed from: a */
    private static boolean m3760a(PackageInfo packageInfo, boolean z) {
        if (packageInfo.signatures.length == 1) {
            packageInfo.signatures[0].toByteArray();
            if (z) {
                return iir.m3761a(packageInfo, f7009c, f7010d);
            }
            return iir.m3761a(packageInfo, f7009c);
        }
    ...
    /* renamed from: a */
    private static boolean m3761a(PackageInfo packageInfo, byte[]... bArr) {
    ...
    /* renamed from: b */
    private static byte[] m3762b(String str) {
        try {
    ...
    /* renamed from: c */
    private final PackageInfo m3763c(String str) {
        try {
            return iad.f6871a.m3601a(this.f7011b).m3600b(str, 64);
        } catch (NameNotFoundException e) {
            String valueOf = String.valueOf(str);
            String str2 = "No package ";
            Log.w("WearSignatureVerifier", valueOf.length() == 0 ? new String(str2) : str2.concat(valueOf));
            return null;
        }
    }

    /* renamed from: a */
    public final boolean m3764a(String str) {
        PackageInfo c = m3763c(str);
        if (c == null) {
            return false;
        }
        if (hue.m3466d(this.f7011b)) {
            return iir.m3760a(c, true);
        }
        boolean a = iir.m3760a(c, false);
        if (a || !iir.m3760a(c, true)) {
            return a;
        }
